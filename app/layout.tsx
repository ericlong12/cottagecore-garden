...
export const metadata = {
  ...
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_SITE_URL ?? "https://cottagecore-garden.vercel.app",
  ),
};
  ...
  return (
    <html lang="en">
      <body className={`${inter.className} ${dm.variable}`}>
        ...
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-50 focus:rounded-md focus:bg-cream focus:px-3 focus:py-2 focus:text-ink focus:shadow-soft focus-ring"
        >
          Skip to content
        </a>
